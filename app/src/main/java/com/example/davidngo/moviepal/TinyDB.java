...
/**
 * David: I did not create this library. All credit goes to KC Ochibili, information found in comment above.
 * This library uses SharedPreferences and made it easier for me to
 * Save objects.
 */
...
public class TinyDB {
    ...
    //David Ngo : Added my own custom methods to get/put movie list objects smoother
    public ArrayList<Movie> getListMovie(String key) {
        Gson gson = new Gson();
        ...
        for (String jObjString : objStrings) {
            Movie value = gson.fromJson(jObjString, Movie.class);
            movieList.add(value);
        }
        return movieList;
    }

    public void putListMovie(String key, ArrayList<Movie> movieList) {
        checkForNullKey(key);
        ...
        for (Movie movie : movieList) {
            objStrings.add(gson.toJson(movie));
        }
        putListString(key, objStrings);
    }
}
